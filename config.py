...
class Config:
    ...
    def load_from_args(self):
        ...
        self.MODEL_SAVE_PATH = 'models/codeforces/saved_model'
        self.TRAIN_DATA_PATH_PREFIX = 'data/my_dataset/my_dataset'
        self.TEST_DATA_PATH = 'data/my_dataset/my_dataset.val.c2v'
