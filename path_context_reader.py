...
class PathContextReader:
    ...
    def _map_raw_dataset_row_to_input_tensors(self, *row_parts) -> ReaderInputTensors:
        ...
        valid_word_mask_per_context_part = [
            ...
            tf.not_equal(path_indices, self.vocabs.path_vocab.word_to_index[self.vocabs.path_vocab.special_words.PAD])]  # [(max_contexts, )] 我觉得是[(max_contexts, ),(max_contexts, ),(max_contexts, )]
