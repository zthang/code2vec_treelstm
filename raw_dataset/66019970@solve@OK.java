public void solve(int testNumber, FastInput in, FastOutput out) {
    ...
    SparseTable<Node> topST = new SparseTable<>(topTrace.toArray(), topTrace.size(), (x, y) -> x.dfn < y.dfn ? x : y);
    SparseTable<Node> botST = new SparseTable<>(botTrace.toArray(), botTrace.size(), (x, y) -> x.dfn < y.dfn ? x : y);
