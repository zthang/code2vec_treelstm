...
data_dir=data/${dataset_name}                      #data/my_dataset
data=${data_dir}/${dataset_name}                   #data/my_dataset/my_dataset
test_data=${data_dir}/${dataset_name}.val.c2v      #data/my_dataset/my_dataset.val.c2v
model_dir=models/${type}                           #models/codeforces
